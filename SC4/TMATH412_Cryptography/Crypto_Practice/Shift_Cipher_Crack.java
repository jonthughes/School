 ...
 */
public class Shift_Cipher_Crack {
    ...
    public static void main(String[] args) {
        Shift_Cipher_Crack scc = new Shift_Cipher_Crack(args[0]);
    }
    
    /*
     * Create shift cipher crack object and run decrypt on input. 
     */
    public Shift_Cipher_Crack(String input) {
        decrypt(input);
    }
...
//        System.out.println("is decrypted to:");
        ...
        System.out.println(possibleShifts[bestM]);
    }
